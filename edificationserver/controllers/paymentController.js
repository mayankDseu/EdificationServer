...
const plan_id = process.env.PLAIN_ID || "plan_MUaelFYPGKPL4W";
...
refund = true;
   ...
   await user.save();
    ...
    res.status(200).json({
        success:true,
        message:refund?"Subscription cancelled, you will recive full refund within 7 days":"Subscription cancelled,now refund initiateed as subscription was canclled after 7 days"
    })
})
